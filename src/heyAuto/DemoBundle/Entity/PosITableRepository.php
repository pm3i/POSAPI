...
{
	public function findItableByCodeTableAndCompanyCode($code_table, $company_code)
	{
		return $this->getEntityManager()->getRepository('heyAutoDemoBundle:PosITable')->findBy(
	...
	public function getItableEmptyByFloor($companyCode, $floor) {
		return $this->getEntityManager()
		->createQuery(
				" SELECT tb
					FROM heyAutoDemoBundle:PosITable tb
